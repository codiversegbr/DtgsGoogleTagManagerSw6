...
- Verbesserung: add_to_wishlist Event feuert nun auch auf der checkout/confirm Seite (GTM-GH-15)
...
# 6.4.9
- Verbesserung: Perfomance Updates für GTM Custom Services Funktion (GTM-GH-71)
- Neu: Rabatt und Original-Preis sind nun Teil des item-Arrays (GTM-GH-69)
...
- New: Events sign_up & login hinzugefügt (GTM-GH-59)
...
- Bugfix: Zusätzliche Abfragen, ob Config Variable gesetzt ist (GTM-GH-40)
